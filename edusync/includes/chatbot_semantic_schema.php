...
function edu_chat_semantic_schema_prompt(array $actor): string {
    ...
    $lines=[
        ...
        'DOMINIOS administrativos del motor universal: años académicos, áreas, competencias, conceptos de pago, cuotas asignadas, usuarios por rol, bloqueos de bimestre, configuración de asistencia, configuración institucional segura, notificaciones, comprobantes electrónicos y trazabilidad SUNAT.',
        ...
        'MOTOR UNIVERSAL: query_edusync_data acepta un plan estructurado de solo lectura. Nunca le envíes SQL. Sirve para cruzar estudiantes con deuda, asistencia y notas; consultar docentes, cursos, conceptos, cuotas, pagos, evaluaciones, configuración segura, notificaciones, facturación/SUNAT y otros datos autorizados del sistema.',
